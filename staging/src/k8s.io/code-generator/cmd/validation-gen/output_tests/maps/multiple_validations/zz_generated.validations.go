...
func Validate_T1(opCtx operation.Context, obj, oldObj *T1, fldPath *field.Path) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(obj map[string]string, oldObj map[string]string, fldPath *field.Path) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(fldPath, obj, true, "field T1.MSS #1")...)
			errs = append(errs, validate.FixedResult(fldPath, obj, true, "field T1.MSS #2")...)
			for key, val := range obj {
				errs = append(errs,
					func(obj string, oldObj *string, fldPath *field.Path) (errs field.ErrorList) {
						errs = append(errs, validate.FixedResult(fldPath, obj, true, "T1.MSS[keys] #1")...)
						errs = append(errs, validate.FixedResult(fldPath, obj, true, "T1.MSS[keys] #2")...)
						return
					}(key, nil, fldPath)...)
				errs = append(errs,
					func(obj string, oldObj *string, fldPath *field.Path) (errs field.ErrorList) {
						errs = append(errs, validate.FixedResult(fldPath, obj, true, "T1.MSS[vals] #1")...)
						errs = append(errs, validate.FixedResult(fldPath, obj, true, "T1.MSS[vals] #2")...)
						return
					}(val, safe.Lookup(oldObj, key), fldPath.Key(key))...)
			}
			return
		}(obj.MSS, safe.Field(oldObj, func(oldObj T1) map[string]string { return oldObj.MSS }), fldPath.Child("mss"))...)
