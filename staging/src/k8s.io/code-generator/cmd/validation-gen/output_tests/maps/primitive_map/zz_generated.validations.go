...
func Validate_T1(obj *T1, fldPath *field.Path) (errs field.ErrorList) {
	...
	// field T1.MSMSS
	errs = append(errs,
		func(obj map[string]map[string]string, fldPath *field.Path) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(fldPath, obj, true, "field T1.MSMSS")...)
			for key, val := range obj {
				errs = append(errs,
					func(obj string, fldPath *field.Path) (errs field.ErrorList) {
						errs = append(errs, validate.FixedResult(fldPath, obj, true, "T1.MSMSS[keys]")...)
						return
					}(key, fldPath)...)
				errs = append(errs,
					func(obj map[string]string, fldPath *field.Path) (errs field.ErrorList) {
						errs = append(errs, validate.FixedResult(fldPath, obj, true, "T1.MSMSS[vals]")...)
						return
					}(val, fldPath.Key(key))...)
			}
			return
		}(obj.MSMSS, fldPath.Child("msmss"))...)
