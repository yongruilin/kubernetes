...
func Validate_T1(in *T1, fldPath *field.Path) (errs field.ErrorList) {
	...
	// PT1
	if in.PT1 != nil {
		errs = append(errs, validate.FixedResult(fldPath.Child("pt1"), *in.PT1, true, "field T1.PT1")...)
	}
	if in.PT1 != nil {
		errs = append(errs, Validate_T1(in.PT1, fldPath.Child("pt1"))...)
	}
...
func Validate_T2(in *T2, fldPath *field.Path) (errs field.ErrorList) {
	...
	// PT1
	if in.PT1 != nil {
		errs = append(errs, validate.FixedResult(fldPath.Child("pt1"), *in.PT1, true, "field T2.PT1")...)
	}
	if in.PT1 != nil {
		errs = append(errs, Validate_T1(in.PT1, fldPath.Child("pt1"))...)
	}
	...
	// PT2
	if in.PT2 != nil {
		errs = append(errs, validate.FixedResult(fldPath.Child("pt2"), *in.PT2, true, "field T2.PT2")...)
	}
	if in.PT2 != nil {
		errs = append(errs, Validate_T2(in.PT2, fldPath.Child("pt2"))...)
	}
