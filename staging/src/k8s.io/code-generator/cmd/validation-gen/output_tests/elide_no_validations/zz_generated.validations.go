...
func Validate_HasTypeVal(opCtx operation.Context, fldPath *field.Path, obj, oldObj *HasTypeVal) (errs field.ErrorList) {
	// type HasTypeVal
	errs = append(errs, validate.FixedResult(opCtx, fldPath, obj, oldObj, false, "type HasTypeVal")...)
