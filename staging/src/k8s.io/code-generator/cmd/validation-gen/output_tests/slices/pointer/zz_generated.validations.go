...
func Validate_T1(opCtx operation.Context, fldPath *field.Path, obj, oldObj *T1) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []*string) (errs field.ErrorList) {
			errs = append(errs, validate.FixedResult(opCtx, fldPath, obj, oldObj, false, "field T1.LPS")...)
			for i, val := range obj {
				errs = append(errs,
					func(fldPath *field.Path, obj, oldObj *string) (errs field.ErrorList) {
						errs = append(errs, validate.FixedResult(opCtx, fldPath, obj, oldObj, false, "T1.LPS[vals]")...)
						return
					}(fldPath.Index(i), val, nil)...)
			}
			return
		}(fldPath.Child("lps"), obj.LPS, safe.Field(oldObj, func(oldObj *T1) []*string { return oldObj.LPS }))...)
