...
| [`k8s:optional`](#k8soptional) | k8s:optional | N/A | Indicates that a field must be specified by clients. | struct fields |
| [`k8s:required`](#k8srequired) | k8s:required | N/A | Indicates that a field is optional to clients. | struct fields |
