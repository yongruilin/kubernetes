...
const (
	...
	// Defines the deep-equal function used for equivalence and ratcheting
	// checks.  The value is a fully-qualified function name, which must be
	// generic over a single type parameter, e.g:
